...
namespace ConfigTransformation_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Marazt.ConfigTransformation.GuidList.guidConfigTransformationCmdSet, (int)Marazt.ConfigTransformation.PkgCmdIDList.cmdidCtxMenuTransformItem);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "ConfigTransformation", "Marazt.ConfigTransformation.ConfigTransformationPackage");

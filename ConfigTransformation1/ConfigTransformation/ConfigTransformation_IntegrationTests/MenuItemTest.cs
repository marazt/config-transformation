...
namespace ConfigTransformation_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(marazt.ConfigTransformation.GuidList.guidConfigTransformationCmdSet, (int)marazt.ConfigTransformation.PkgCmdIDList.cmdidToolMenuCmd);

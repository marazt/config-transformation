...
using marazt.ConfigTransformation;

namespace ConfigTransformation_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new ConfigTransformationPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(marazt.ConfigTransformation.GuidList.guidConfigTransformationCmdSet, (int)marazt.ConfigTransformation.PkgCmdIDList.cmdidToolMenuCmd);
